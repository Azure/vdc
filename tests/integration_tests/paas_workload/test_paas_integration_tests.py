...
class PaaSIntegrationTests(BaseIntegrationTestCase):
    
    def setUp(self):
        super(PaaSIntegrationTests, self).setUp()
    ...
    def test_e_workload_sqldb_creation(self):
        
        self.set_resource_to_deploy('sqldb', args)
        self.upload_scripts(args, False)
        self.create_vdc_storage(args, False)
        successful: bool = self.execute_deployment_test(
            args,
    ...
    def test_f_workload_ase_creation(self):
        
        self.set_resource_to_deploy('ase', args)
        self.upload_scripts(args, False)
        self.create_vdc_storage(args, False)
        successful: bool = self.execute_deployment_test(
            args,
