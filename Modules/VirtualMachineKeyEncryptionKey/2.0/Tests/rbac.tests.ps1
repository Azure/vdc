<#
	.NOTES
		...
		Purpose:	Pester - Test Virtual Machine KeyEncryption Key ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Azure Virtual Machine KeyEncryption Key ARM template synatax.
