<#
	.NOTES
		...
		Purpose:	Pester - Test WebApp Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Web App ARM template synatax.
...
Describe "Template: $template - WebApp" -Tags Unit {
