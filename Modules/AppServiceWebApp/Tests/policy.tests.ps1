<#
	.NOTES
		...
		Purpose:	Pester - Test App Services Environments WebApp ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test App Services Environments WebApp ARM template synatax.
...
if ($null -ne $TemplateFileTestCases -and 
    ...
    Describe "Template: $template - App Services Environments WebApp" -Tags Unit {
