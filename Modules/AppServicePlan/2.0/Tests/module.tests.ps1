<#
	.NOTES
		...
		Purpose:	Pester - Test AppService Plan Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test App Service Plan ARM template synatax.
...
Describe "Template: $template - App Service Plan" -Tags Unit {
