<#
	.NOTES
		...
		Purpose:	Pester - Test Application Service Environment App Service Plan ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Application Service Environment App Service Plan ARM template synatax.
...
if ($null -ne $TemplateFileTestCases -and 
    ...
    Describe "Template: $template - Application Service Environment App Service Plan" -Tags Unit {
