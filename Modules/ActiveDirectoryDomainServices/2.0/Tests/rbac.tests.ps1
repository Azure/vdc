<#
	.NOTES
		...
		Purpose:	Pester - Test Active Directory Domain Services ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Azure Active Directory Domain Services ARM template synatax.
...
if ($null -ne $TemplateFileTestCases -and 
    ...
    Describe "Template: $template - Active Directory Domain Services" -Tags Unit {
