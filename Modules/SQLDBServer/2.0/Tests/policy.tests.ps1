<#
	.NOTES
		...
		Purpose:	Pester - Test SQL Database Server ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Azure SQL Database Server ARM template synatax.
...
if ($null -ne $TemplateFileTestCases -and 
    ...
    Describe "Template: $template - SQL Database Server" -Tags Unit {
