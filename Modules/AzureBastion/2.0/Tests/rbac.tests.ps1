<#
	.NOTES
		...
		Purpose:	Pester - Test Azure Bastion ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Azure Azure Bastion ARM template synatax.
...
if ($null -ne $TemplateFileTestCases -and 
    ...
    Describe "Template: $template - Azure Bastion" -Tags Unit {
