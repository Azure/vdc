<#
	.NOTES
		...
		Purpose:	Pester - Test Route Tables ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Azure Route Tables ARM template synatax.
...
if ($null -ne $TemplateFileTestCases -and 
    ...
    Describe "Template: $template - Route Tables" -Tags Unit {
