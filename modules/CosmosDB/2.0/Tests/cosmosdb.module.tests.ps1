<#
	.NOTES
		...
		Purpose:	Pester - Test Cosmosdb ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Cosmosdb ARM template synatax.
...
Describe "Template: $template - Cosmosdb" -Tags Unit {
