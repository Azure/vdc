<#
	.NOTES
		...
		File:		data.factories.module.tests.ps1

		Purpose:	Pester - Test Data Factories ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Data Factories ARM template synatax.
...
Describe "Template: $template - Data Factories" -Tags Unit {
