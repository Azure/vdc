<#
	.NOTES
		...
		File:		function.apps.module.tests.ps1

		Purpose:	Pester - Test Function Apps ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Function Apps ARM template synatax.
...
Describe "Template: $template - Function Apps" -Tags Unit {
