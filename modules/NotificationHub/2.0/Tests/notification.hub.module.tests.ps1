<#
	.NOTES
		...
		File:		notification.hub.module.tests.ps1

		Purpose:	Pester - Test Notification Hub ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Notification Hub ARM template synatax.
...
Describe "Template: $template - Notification Hub" -Tags Unit {
