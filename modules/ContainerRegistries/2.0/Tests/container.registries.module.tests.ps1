<#
	.NOTES
		...
		File:		container.registries.module.tests.ps1

		Purpose:	Pester - Test Azure Container Registries ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Azure Container Registries ARM template synatax.
...
Describe "Template: $template - Azure Container Registries" -Tags Unit {
