<#
	.NOTES
		...
		File:		redis.cache.module.tests.ps1

		Purpose:	Pester - Test Redis Cache ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Redis Cache ARM template synatax.
...
Describe "Template: $template - Redis Cache" -Tags Unit {
