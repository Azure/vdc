<#
	.NOTES
		...
		File:		sql.database.module.tests.ps1

		Purpose:	Pester - Test SQL Database ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test SQL Database ARM template synatax.
...
Describe "Template: $template - SQL Database" -Tags Unit {
