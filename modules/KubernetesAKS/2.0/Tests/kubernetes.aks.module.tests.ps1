<#
	.NOTES
		...
		File:		kubernetes.aks.module.tests.ps1

		Purpose:	Pester - Test Kubernetes Azure Container Service ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Kubernetes Azure Container Service ARM template synatax.

	.DESCRIPTION
		This script contains functionality used to test AKubernetes Azure Container Service ARM template synatax.
...
Describe "Template: $template - Kubernetes AKS" -Tags Unit {
	...
	Context "Template File Syntax" {
		...
		It "Converts from JSON and has the expected properties" -TestCases $TemplateFileTestCases {
		 ...
		 It "Converts from JSON and has the expected Azure Resources" -TestCases $TemplateFileTestCases {
            ...
            $templateResources = (Get-Content (Join-Path "$here" "$TemplateFile") `
