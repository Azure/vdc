<#
	.NOTES
		...
		Purpose:	Pester - Test MySQL ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test MySQL ARM template synatax.
...
Describe "Template: $template - MySQL" -Tags Unit {
