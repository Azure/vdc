<#
	.NOTES
		...
		File:		logic.apps.module.tests.ps1

		Purpose:	Pester - Test Logic Apps ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Logic Apps ARM template synatax.
...
Describe "Template: $template - Logic Apps" -Tags Unit {
