<#
	.NOTES
		...
		File:		api.management.module.tests.ps1

		Purpose:	Pester - Test API Management ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test API Management ARM template synatax.
...
Describe "Template: $template - API Management" -Tags Unit {
