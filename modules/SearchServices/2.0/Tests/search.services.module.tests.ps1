<#
	.NOTES
		...
		File:		search.services.module.tests.ps1

		Purpose:	Pester - Test Search Services ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test Search Services ARM template synatax.
...
Describe "Template: $template - Search Services" -Tags Unit {
