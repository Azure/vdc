<#
	.NOTES
		...
		File:		app.service.environment.module.tests.ps1

		Purpose:	Pester - Test App Services ARM Templates

		Version: 	1.0.0.0 - 1st April 2019 - Azure Virtual Datacenter Development Team
		==============================================================================================

	.SYNOPSIS
		This script contains functionality used to test App Services ARM template synatax.
...
Describe "Template: $template - App Services" -Tags Unit {
